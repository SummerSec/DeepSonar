...
/**
 * Apply the latest baseline or the supported v12→v15 chain on one reserved
...
export async function runMigrations(
  ...
  // future/legacy row must fail closed without partially applying v13..v15.
