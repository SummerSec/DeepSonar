...
const ROUTE_SCOPES: Record<string, string> = {
  ...
  "GET /projects/:id/settings": "profiles:read",
  "PATCH /projects/:id/settings": "profiles:write",
  "GET /projects/:id/roles": "profiles:read",
  ...
  "PATCH /agent-profiles/:id": "profiles:write",
  "DELETE /agent-profiles/:id": "profiles:write",
  "GET /agent-roles": "profiles:read",
  "POST /agent-roles": "profiles:write",
  "PATCH /agent-roles/:id": "profiles:write",
  "DELETE /agent-roles/:id": "profiles:write",
  "GET /role-configs/global": "profiles:read",
  "PUT /role-configs/global/:roleId": "profiles:write",
  "GET /projects/:id/role-configs": "profiles:read",
  "PUT /projects/:id/role-configs/:roleId": "profiles:write",
  "DELETE /projects/:id/role-configs/:roleId": "profiles:write",
  "GET /global-settings": "profiles:read",
  "PATCH /global-settings": "profiles:write",
