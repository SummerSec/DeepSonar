...
const OPERATION_DESCRIPTIONS: Record<string, { summary: string; description: string; readOnly: boolean; eventType: string | null }> = {
  ...
  list_available_runtime_images: {
    ...
    description: "Return the live project-enabled, trusted runtime image catalog (image_key, display fields, compatible_agent_clis, readiness) visible to this Hub Job. Entries never include executable OCI refs or digests.",
    readOnly: true,
    eventType: null,
  },
  list_shared_assets: {
