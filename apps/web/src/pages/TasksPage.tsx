          ...
          {form.kind === "compose" && (
            <section className="theme-surface rounded-lg border p-4" aria-labelledby="compose-seeds-heading">
              ...
              <div className="mt-3 grid gap-2 sm:grid-cols-2 xl:grid-cols-6">
                ...
                <SearchableMultiSelect value={seedDispositions} onChange={setSeedDispositions} options={DISPOSITION_OPTIONS.filter((option) => ["open", "accepted", "human_reproducing", "confirmed_vuln"].includes(option.value))} placeholder="全部处置" ariaLabel="按处置状态筛选种子" className="block [&>button]:w-full" />
...
export function TasksPage() {
  ...
  return (
    <div className="page-scroll">
      ...
      <div className="mb-5"><UsageLedgerBoard scope="project" projectId={projectId} /></div>
