...
export interface JobSummary {
  ...
  project_name?: string;
  canvas_title?: string;
  /** 冻结快照：所用 Agent CLI（claude-code / pi / dsh，历史 leftover 可能为 codex / open-code） */
...
export const api = {
  ...
  updateRoleConfigAgentCli: (roleConfigId: string, agent_cli: CurrentAgentCli) =>
  ...
  createCredential: (c: {
    ...
    agent_cli?: CurrentAgentCli | null;
