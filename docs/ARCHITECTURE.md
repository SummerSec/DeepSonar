...
- **质量指标与 Hub 回放（#445 Phase 1）**：`GET /dashboard/quality` 与项目/任务别名从现有 Job、Finding、Verify、Usage Ledger 只读派生确认率、误报率、Verify 分歧、人工介入与单 Finding 成本；`GET …/quality/replay` 输出冻结 `hub_replay` v1。不改变 Hub 决策，不写 Experience
