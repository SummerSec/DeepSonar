...
> **状态：as-built + 历史推演**（2026-08-13 回写）。  
> **已落地（对照代码）**：CLI Session 归档与下载、过程流 inflight/finalize、Job 详情多 Tab、WS **ticket 鉴权**（#38 已关）、stream-bus、OTLP 路径、Session 查看器（Web）、Finding 详情/筛选、Credential 模型目录与并发配额等。  
> 下文 §1「现状问题」是 **2026-08-02 样本**，**勿当当前缺陷清单**。冲突时以 `DESIGN.md`、代码与 OpenAPI 为准。  
