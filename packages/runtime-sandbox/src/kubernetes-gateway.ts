 ...
 * create (#346). That path is the only create that requests
 * bootstrap.execd.isolation=enable (#427 / #432). Docker uses Engine
 * `docker exec` instead (#423) and must omit the extension.
 */
