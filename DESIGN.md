...
| 实时流 | #38 / #388 | #38 鉴权已关；#388 已明确三职责并收口补读。bus 仍单进程投递缓存；跨副本只在共享 `BLOB_DIR` 时能补读，file-tail 未做 |
