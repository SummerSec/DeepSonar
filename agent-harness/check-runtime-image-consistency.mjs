...
expect(chromeFuzzDockerfile.includes("clang_base_path=\"/usr/lib/llvm-16\"") && chromeFuzzDockerfile.includes("clang_version=\"16\"") && chromeFuzzDockerfile.includes("clang_use_chrome_plugins=false") && chromeFuzzDockerfile.includes("aarch64-unknown-linux-gnu") && chromeFuzzDockerfile.includes("chrome-fuzz-toolchain-preflight.sh") && chromeFuzzPreflight.includes("/usr/bin/ninja") && chromeFuzzPreflight.includes("file -Lb") && chromeFuzzPreflight.includes("libclang_rt[.]builtins"), "Chrome Fuzz arm64 must align GN with native LLVM 16 runtime paths and run the generated-toolchain preflight");
