...
expect(Array.isArray(basePiWeb?.compatible_image_keys) && basePiWeb.compatible_image_keys.includes("deepsonar-base") && basePiWeb.compatible_image_keys.includes("deepsonar-audit"), "pi-web-access base/audit compatibility missing");
