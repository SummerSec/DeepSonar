...
expect(clickhouseFuzzEnv.includes(".fuzz.actual == true") && clickhouseFuzzSmoke.includes("refusing toy fallback") && clickhouseFuzzSmoke.includes("SELECT 40 + 2") && clickhouseFuzzSmoke.includes("--config-file") && !clickhouseFuzzDockerfile.includes("toy"), "ClickHouse Fuzz must fail closed without the official clickhouse-local binary");
