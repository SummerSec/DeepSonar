...
-- Scheduler locks the row instead of scanning attempts. Username buckets
-- enforce 5 failed verifications / 5 minutes; IP buckets bound spraying.
CREATE TABLE login_rate_limits (
  ...
  CONSTRAINT login_rate_limits_scope_check CHECK (scope IN ('username', 'ip')),
